...
export class SVGColor
{
   ...
   public static getColorByName(name: string): string
   {
      return SVGColor.colors[name.toLowerCase()];
   }

   public static parseToInt(s: string): number
   {
      if ( s == null )
         return 0x000000;
      ...
      } else if ( s.indexOf( "(" ) >-1 )
      {
         ...
         return SVGColor.parseToInt( SVGColor.getColorByName( s ) );
      }
   }

   //Used in another project, can be deleted.
   public static flashToSVG( color: number ): string
   {
